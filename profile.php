...
<body>
    ...
    <div class="container">
        <div class="overlay">
            <h2 class="text-center mb-4">Profil Perusahaan</h2>
            <p>
                Kami adalah perusahaan teknologi yang berdiri sejak 2010 dan berfokus pada pengembangan aplikasi web, solusi IT, dan layanan konsultasi digital.
            </p>
            <p>
                Selama lebih dari satu dekade, kami telah membangun reputasi melalui kemitraan strategis dengan berbagai institusi dan perusahaan dari sektor publik maupun swasta.
            </p>

            <h4 class="mt-5">Pengalaman Kami</h4>
            <table class="table table-striped table-dark table-bordered mt-3">
                ...
                <tbody>
                    <tr>
                        <td>2018</td>
                        <td>Solusi IT untuk manufaktur</td>
                        <td>Bahlil Lahadalia</td>
                    </tr>
                </tbody>
            </table>
        </div>
